                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="d-flex flex-column h-100">
                      <h2 class="font-weight-bolder mb-0">Search Transfer Patient</h2>
                    </div>
                ...
                ?>
                  <div class="card mb-4 ">
                    ...
                    ?>
                              <tbody>
                                <tr class="row">
                                    ...
                                    <td class="col">
                                      <div class="">
                                        <a href="./transfer-patient.php?pid=<?php echo $row['p_id']; ?>" class="btn bg-gradient-warning m-0" style="padding: 4px 19px;">Transfer</a>
                                      </div>
                                    </td>
                                  </tr>
                    ...
                    " style="margin-top: -15px; text-align:center;">
                        ...
                        <a href="./transfer.php?more=<?php echo ($more+1); ?>">
