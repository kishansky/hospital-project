                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="d-flex flex-column h-100">
                      <h2 class="font-weight-bolder mb-0">Dischage Patient</h2>
                    </div>
                ...
                ?>
                  <div class="card mb-4 ">
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col">
                                      <div class="">
                                        ...
                                        <a href="./discharge-bill.php?pid=<?php echo $row['p_id']; ?>" class="btn bg-gradient-success m-0" style="padding: 4px 19px;">Dischage</a>
                                    <?php }else{
                                    ?>
                                        <a href="./discharge-bill.php?pid=<?php echo $row['p_id']; ?>" class="btn bg-gradient-danger m-0" style="padding: 4px 19px;">Dischaged</a>
                    ...
                    " style="margin-top: -15px; text-align:center;">
                        ...
                        <a href="./discharge-patient.php?more=<?php echo ($more+1); ?>">
