          ...
          <div class="col-lg-7 position-relative z-index-2 w-lg-100">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="d-flex flex-column h-100">
                      <h2 class="font-weight-bolder mb-0">Search Discharge Patient</h2>
                    </div>
            ...
            <div class="row mt-4">
               ...
               if(isset($_POST['search'])){
                ...
                $sql = "SELECT * FROM patients WHERE p_id LIKE '%{$search}%' OR p_name LIKE '%{$search}%' AND p_status = 0 ORDER BY p_id DESC LIMIT $limit";
                $result = mysqli_query($conn,$sql) or die ("Query Failed.");              
              }else{
                $sql = "SELECT * FROM patients WHERE p_status = 0 ORDER BY p_id DESC LIMIT $limit";
                $result = mysqli_query($conn,$sql) or die ("Query Failed.");
              }
               ?>
                  <div class="card mb-4 ">
                    ...
                    ?>
                              <tbody>
                                <tr class="row">
                                    ...
                                    <td class="col">
                                      <div class="">
                                        <a href="./discharge-summary.php?pid=<?php echo $row['p_id']; ?>" class="btn bg-gradient-success m-0" style="padding: 4px 19px;">Summary</a>
                                      </div>
                                    </td>
                                  </tr>
                    ...
                    " style="margin-top: -15px; text-align:center;">
                        ...
                        <a href="./discharge-list.php?more=<?php echo ($more+1); ?>">
