          ...
          <div class="col-lg-7 position-relative z-index-2 w-lg-100">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="d-flex flex-column h-100">
                      <h2 class="font-weight-bolder mb-0">Search Birth Certificate</h2>
                    </div>
            ...
            <div class="row mt-4">
              ...
              <div class="col text-center ">
                <a href="./birth-certificate.php">
                  <button class="btn btn-info bg-gradient-info ms-1">
                  <i class="material-icons opacity-10">add</i>Add New Certificate
                  </button>
                </a>
              </div>
            </div>
            <div class="row mt-4">
              ...
              if(isset($_POST['search'])){
                ...
                $sql = "SELECT * FROM birth_c WHERE b_id LIKE '%{$search}%' OR name LIKE '%{$search}%'ORDER BY b_id DESC LIMIT $limit";
                $result = mysqli_query($conn,$sql) or die ("Query Failed.");
              }else{
                $sql = "SELECT * FROM birth_c ORDER BY b_id DESC LIMIT $limit";
                $result = mysqli_query($conn,$sql) or die ("Query Failed.");
              }
                ?>
                  <div class="card mb-4 ">
                    ...
                    ?>
                              <tbody>
                                <tr class="row">
                                    ...
                                    <td class="col">
                                      <div class="">
                                        <p class="text-xs font-weight-bold mb-0 ">Father,s name:</p>
                                        <h6 class="text-sm font-weight-normal mb-0
                                          "><?php echo $row['father']; ?></h6>
                                      </div>
                                    </td>
                                    <td class="col">
                                      <div class="">
                                        ...
                                        <h6 class="text-sm font-weight-normal mb-0
                                          "><?php echo substr($row['address'],0,15)."...."; ?></h6>
                                      </div>
                                    </td>
                                    
                                    <td class="col">
                                      <div class="">
                                        <a href="./birth-print.php?bid=<?php echo $row['b_id']; ?>" class="btn bg-gradient-warning m-0" style="padding: 4px 19px;">Print</a>
                                      </div>
                                    </td>
                                  </tr>
                              </tbody>
                    ...
                    " style="margin-top: -15px; text-align:center;">
                        ...
                        <a href="./search-birth.php?more=<?php echo ($more+1); ?>">
