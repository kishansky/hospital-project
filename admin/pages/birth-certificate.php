        ...
        <form  action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlTextarea1" name="c_name" rows="3" style="color:#000;border: 1px solid #f20c54;padding:0.5rem;" autofocus >
                                    </div>
                                  </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlTextarea1" name="father" rows="3" style="color:#000;border: 1px solid #f20c54;padding:0.5rem;">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="">
                                ...
                                <div class="col-md-6 ">
                                  ...
                                  <div class="col-md-6 ">
                                    ...
                                    <input type="date" class="form-control" id="exampleFormControlTextarea1" placeholder="dd/mm/yyyy" name="Date" rows="3" style="color:#000;border: 1px solid #f20c54;padding:0.5rem;">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-6 ">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlTextarea1" placeholder="hh:mm:ss am/pm" name="time" rows="3" style="color:#000;border: 1px solid #f20c54;padding:0.5rem;">
                                    </div>
                                  </div>
